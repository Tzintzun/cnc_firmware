/*Compilacion: g++ inih/ini.c inih/cpp/INIReader.cpp trayectorias.cpp actuadores.cpp interprete.cpp errores.cpp pruebas/test_manipulador_actuadores_num_pasos.cpp -o pruebas/test_manipulador_actuadores_num_pasos -l wiringPi*/
